...
import kr.co.dongduk.medineye.activity.MediInfoActivity;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Main_MediInfo_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Main_MediInfo_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Main_MediInfo_Fragment extends Fragment implements TextToSpeech.OnInitListener{
    ...
    public static Main_MediInfo_Fragment newInstance(int param1, String param2) {
        Main_MediInfo_Fragment fragment = new Main_MediInfo_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //여기에 click 넣어서 화면 전환시키고
        //음계 출력해주기.

        View v = inflater.inflate(R.layout.fragment_main_mediinfo, container, false);
        final GestureDetector gesture = new GestureDetector(getActivity(),
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onDoubleTap(MotionEvent e) {
                        // *******   더블 탭 : 연속 두번 터치시 발생   ***********
                        //화면전환
                        Intent intent = new Intent(getActivity(), MediInfoActivity.class);
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        ...
                        //TTS
                        str = getString(R.string.tts_medicine);
                        _ttsActive = true;
