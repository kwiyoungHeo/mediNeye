...
import kr.co.dongduk.medineye.activity.AlarmActivity;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Main_Alarm_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Main_Alarm_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Main_Alarm_Fragment extends Fragment implements TextToSpeech.OnInitListener{
    ...
    public static Main_Alarm_Fragment newInstance(int param1, String param2) {
        Main_Alarm_Fragment fragment = new Main_Alarm_Fragment();
        Bundle args = new Bundle();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("AlarmOnCreate", "AlarmOnCreate");
        ...
        final GestureDetector gesture = new GestureDetector(getActivity(),
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        ...
                        //TTS
                        _ttsActive = true;
                        _tts.speak(getString(R.string.tts_alarm), TextToSpeech.QUEUE_FLUSH, null);
