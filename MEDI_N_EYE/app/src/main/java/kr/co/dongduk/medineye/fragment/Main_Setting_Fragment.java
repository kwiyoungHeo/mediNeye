...
import kr.co.dongduk.medineye.activity.SettingActivity;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Main_Setting_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Main_Setting_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Main_Setting_Fragment extends Fragment implements TextToSpeech.OnInitListener{
    ...
    public static Main_Setting_Fragment newInstance(int param1, String param2) {
        Main_Setting_Fragment fragment = new Main_Setting_Fragment();
        ...
        final GestureDetector gesture = new GestureDetector(getActivity(),
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onSingleTapConfirmed(MotionEvent e) {
                        ...
                        //TTS
                        _ttsActive = true;
                        _tts.speak(getString(R.string.tts_setting), TextToSpeech.QUEUE_FLUSH, null);
